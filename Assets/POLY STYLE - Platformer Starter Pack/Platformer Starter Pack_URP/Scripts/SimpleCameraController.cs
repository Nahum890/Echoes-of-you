...
namespace PolyStyle.Platformer
{
    /// <summary>
    /// Cámara de vuelo del starter pack POLY (renombrada para no chocar con Particle Pack / UnityTemplateProjects).
    /// </summary>
    public class PolyStyleSimpleCameraController : MonoBehaviour
    {
        class CameraState
        {
            public float yaw;
