...
```mermaid
graph TD
    C1[Capítulo I: Persistencia] -->|Degradación espacial| C2[Capítulo II: Coordinación]
    C2 -->|Pérdida de luz y fe| C3[Capítulo III: Confianza]
    C3 -->|Foco íntimo y rosa| C4[Capítulo IV: Optimización]
    C4 -->|Colapso físico y estática| C5[Capítulo V: Consecuencia]
    C5 -->|Abismo final sin retorno| C6[Capítulo VI: Aceptación]
```
